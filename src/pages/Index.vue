  ...
  <Layout>
    ...
    <v-timeline :dense="toggleTimeLineDense">
      <v-timeline-item
        ...
        v-show="Date.parse(row.node.date) >= Date.parse(dateVon) && Date.parse(row.node.date) <= Date.parse(`${dateBis} 23:59:59`) "
      >
